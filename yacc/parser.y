...
CompUnit: Decl CompUnit {$$=$2;$$->push_front((BaseAST*)$1);$$->SET(@1);}
        | FuncDef CompUnit {$$=$2;$$->push_front((BaseAST*)$1);$$->SET(@1);}
        | Decl {$$=new CompUnit((BaseAST*)$1);$$->SET(@1);}
        | FuncDef {$$=new CompUnit((BaseAST*)$1);$$->SET(@1);}
        ;
...
ConstInitVal: AddExp {$$=new InitVal((BaseAST*)$1);$$->SET(@1);}
            | Y_LBRACKET Y_RBRACKET {$$=new InitVal();$$->SET(@1);}
            | Y_LBRACKET ConstInitVals Y_RBRACKET {$$=new InitVal((BaseAST*)$2);$$->SET(@1);}
            ;
...
InitVal: AddExp {$$=new InitVal((BaseAST*)$1);$$->SET(@1);}
       | Y_LBRACKET Y_RBRACKET {$$=new InitVal(nullptr);$$->SET(@1);}
       | Y_LBRACKET InitVals Y_RBRACKET {$$=new InitVal((BaseAST*)$2);$$->SET(@1);}
       ;
